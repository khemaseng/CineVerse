        ...
        <div className="flex flex-col justify-between bg-[#042454] p-8 md:w-[45%] md:p-10">
          ...
          <div className="mt-8 border-t border-white/10 pt-6">
            <p className="text-xs leading-relaxed text-white/80">
              &ldquo;Every film has a story worth experiencing. Join CineVerse
              to explore, track, and share movies.&rdquo;
            </p>
            ...
            >
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700">
                  Full Name <span className="text-[#f5a524]">*</span>
                </label>
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700">
                  Confirm Password <span className="text-[#f5a524]">*</span>
                </label>
                <div className="relative mt-1">
                  <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
                    <Lock size={15} />
